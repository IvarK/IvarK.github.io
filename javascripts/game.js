...
function set_cookie(cookie_name, value) {
    localStorage[cookie_name] = btoa(JSON.stringify(value, function(k, v) { return (v === Infinity) ? "Infinity" : v; }))
}

function get_cookie(cookie_name) {
    var c_value = document.cookie;
    if (localStorage[cookie_name] !== null) {
        return JSON.parse(atob(localStorage[cookie_name], function(k, v) { return (v === Infinity) ? "Infinity" : v; }))
    } else {
