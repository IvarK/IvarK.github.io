...
function updateDimensions() {
    ...
    if (player.replicanti.galaxies > 0 && (player.galaxies >= 100 || player.currentEternityChall === "eterc5")) document.getElementById("secondResetLabel").innerHTML = 'Distant Antimatter Galaxies ('+ player.galaxies +' + '+ player.replicanti.galaxies +'): requires ' + getGalaxyRequirement() + ' Eighth Dimensions';
    else if (player.galaxies >= 100 || player.currentEternityChall === "eterc5") document.getElementById("secondResetLabel").innerHTML = 'Distant Antimatter Galaxies ('+ player.galaxies +'): requires ' + getGalaxyRequirement() + ' Eighth Dimensions';
...
function DimensionPower(tier) {
    ...
    if (player.eternityUpgrades.includes(2)) mult = mult.times(Decimal.pow(player.eternities/300 + 1, Math.log(player.eternities*2+1)/Math.log(4)))
...
function getTimeDimensionPower(tier) {
    ...
    if (ECTimesCompleted("eterc10") !== 0) ec10bonus = new Decimal(player.infinitied * ECTimesCompleted("eterc10") * 0.000002+1)
...
function updateEternityUpgrades() {
    ...
    document.getElementById("eter4").className = (player.eternityUpgrades.includes(4)) ? "eternityupbtnbought" : (player.eternityPoints.gte(1e18)) ? "eternityupbtn" : "eternityupbtnlocked"
...
setInterval(function() {
    ...
    document.getElementById("eterc3goal").innerHTML = "Goal: "+shortenCosts(new Decimal("1e600").times(new Decimal("1e100").pow(ECTimesCompleted("eterc3"))).max(new Decimal("1e600"))) + " IP"
...
function gameLoop(diff) {
    ...
    document.getElementById("ec2reward").innerHTML = "Reward: Infinity power affects Infinity Dimensions with reduced effect, Currently: "+shortenMoney(player.infinityPower.pow(1.5/(700 - ECTimesCompleted("eterc2")*100)).min(new Decimal("1e100")))+"x"
    ...
    document.getElementById("ec10reward").innerHTML = "Reward: Time dimensions gain a multiplier from infinitied stat, Currently: "+shortenMoney(player.infinitied * ECTimesCompleted("eterc10") * 0.00002+1)+"x "
    if (player.timestudy.studies.includes(31)) document.getElementById("ec10reward").innerHTML = "Reward: Time dimensions gain a multiplier from infinitied stat, Currently: "+shortenMoney(Decimal.pow(player.infinitied * ECTimesCompleted("eterc10") * 0.00002+1, 4))+"x "
