...
setInterval(function() {
    ...
    document.getElementById("eterc9goal").innerHTML = "Goal: "+shortenCosts(new Decimal("1e400").times(new Decimal("1e100").pow(ECTimesCompleted("eterc8"))).max(new Decimal("1e1300"))) + " IP"
