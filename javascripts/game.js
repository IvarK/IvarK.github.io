...
setInterval(function () {
    ...
    document.getElementById("progressbar").style.width = (Math.log10(player.money) / Math.log10(Number.MAX_VALUE) * 100).toFixed(2) + "%"
    document.getElementById("progressbar").innerHTML = (Math.log10(player.money) / Math.log10(Number.MAX_VALUE) * 100).toFixed(2) + "%"
