...
function DimensionPower(tier) {
    ...
    if (ECTimesCompleted("eterc9") !== 0) mult = mult.times(player.timeShards.pow(ECTimesCompleted("eterc9")*0.15).plus(1).min(new Decimal("1e400"))
    return mult
}
...
function gameLoop(diff) {
    ...
    document.getElementById("ec9reward").innerHTML = "Reward: Infinity Dimension multiplier based on time shards, Currently: "+shortenMoney(player.timeShards.pow(ECTimesCompleted("eterc9")*0.15).min(new Decimal("1e400"))+"x "
