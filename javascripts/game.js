...
setInterval(function() {
    ...
    document.getElementById("eterc3goal").innerHTML = "Goal: "+shortenCosts(new Decimal("1e575").times(new Decimal("1e100").pow(ECTimesCompleted("eterc3"))).max(new Decimal("1e575"))) + " IP"
