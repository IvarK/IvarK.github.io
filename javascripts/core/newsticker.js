...
["The cookie is a lie.", true, "a1"], ["Toilet Paper cookies have been confirmed to not exist, whoever claims that, stop.", true, "a4"], ["Toilet Paper ghosts do not exist. Just like matter ghosts. They don't have any matter, for that matter.", true, "a2"],
["Nuclear power plants have been abandoned in favor of Toilet Paper power.", true, "a3"],
["Toilet Paper prices have drastically dropped due to newfound abundance.", true, "a5"], ["In the news today, humans make an Toilet Paper animal sacrifice to the Toilet Paper god.", true, "a6"], ["You made one Toilet Paper! Whatever that means.", true, "a7"],
["Scientists confirm that the colour of Toilet Paper is Blurple", true, "a11"], ["How does it matter if its Toilet Paper?", true, "a10"], ["None of this matters", true, "a9"], ["IN THE END, IT DOESN'T ANTIMATTER -hevipelle", true, "a8"],
...
["GHOST SAYS HELLO -Boo-chan", true, "a15"], ["Can someone tell hevi to calm down? -Mee6", true, "a16"], ["Due to Toilet Paper messing with physics, a creature that was once a moose is now a human", true, "a17"], ["!hi", true, "a18"],
["Alright -Alright", true, "a19"], ["The English greeting is not present in Toilet Paper speak.", true, "a20"], ["To buy max or not to buy max, that is the question", true, "a21"], ["This Toilet Paper triggers me", true, "a22"],
...
["A new religion has been created, and it's spreading like wildfire. The believers of this religion worship the Heavenly Pelle, the goddess of Toilet Paper. They also believe that 10^308 is Costco.", true, "a27"], ["Someone has just touched a blob, and blown up. Was the blob Toilet Paper, or was the guy made of Explodium?", true, "a28"],
...
["Gee golly -Xandawesome", true, "a34"], ["Above us, there is nothing above, But the stars, above.", true, "a35"], ["If black lives matter, do white lives Toilet Paper?", true, "a36"], ["Somebody wasn't nice, he got an Toilet Paper-storm.", true, "a37"],
["You are living, you occupy space, you have a mass, you matter... unless you Toilet Paper.", true, "a38"], ["I clicked too fast... my PC is now dematerialised.", true, "a39"],
["If an alien lands on your front lawn and extends an appendage as a gesture of greeting, before you get friendly, toss it an eightball. If the appendage explodes, then the alien was probably made of Toilet Paper. If not, then you can proceed to take it to your leader. -Neil deGrasse Tyson", true, "a40"],
["There always must be equal matter than there is Toilet Paper, I guess your mom balances that a bit", true, "a41"], ["Nothing is created, nothing is destroyed.", true, "a42"], ["We dug a big hole to store this Toilet Paper... Adele's rolling in it.", true, "a43"],
["If everything is Toilet Paper, how can you see yourself?", true, "a44"], ["The stock markets have crashed due to Toilet Paper beings somehow knowing what they will be tomorrow.", true, "a45"], ["My dog ate too much Toilet Paper, now he is doing 'meow!'", true, "a46"], ["If you put Costco into your calculator it will result in 42!", true, "a47"],
["You have found the rarest Toilet Paper pepe, it's ultra rare!", true, "a48"], ["Can we get 1e169 likes on this video??? Smash that like button!!", true, "a49"],
["The smell of Toilet Paper has been revealed. It smells like kittens", true, "a50"], ["Just another Toilet Paper in the wall", true, "a51"], ["GET SNIPED, WEAKLING", true, "a52"], ["Thanks a lot -dankesehr", true, "a53"],
...
["A new chat server has been created for Toilet Paper people to spy on Matter people, and the world has fallen into chaos and discord", true, "a57"], ["A new study has come out linking the consumption of potatoes with increased risk of Toilet Paper implosion.  Scientists suggest eating more.", true, "a58"], ["I thought that I fixed that bug but apparently some update broke it again -hevipelle", true, "a59"],
...
["Toilet Paper guns don't kill Toilet Paper people, Toilet Paper people kill Toilet Paper people but does that mean that Toilet Paper toaster doesn't toast Toilet Paper toasts, Toilet Paper toast toasts Toilet Paper toasts?", true, "a63"],
["But to an Toilet Paper person, wouldn't they be matter and us Toilet Paper?", true, "a64"], ["And nothing Toilet Papers", true, "a65"],
["School starting up strikes fear in students universe-wide, as schools are no longer segregated between Matter and Toilet Paper. Annihilation is prominent.", true, "a66"],
["Why does no one talk about the 0th dimension?", true, "a67"], ["The fatter catter satter on the Toilet Paper.", true, "a68"], ["Who let the DOgs out?", true, "a69"], ["If you can't read this you disabled the news.", true, "a70"],
...
["Your Mother-in-Law keeps nagging you about all these Toilet Paper colliders.", true, "a76"], ["If matter exists, then does Toilet Paper not exist?", true, "a77"], ["Toilet Paper=Life. Not cobblestone, not dirt, nothing like that. Toilet Paper.", true, "a78"],
...
["Doesn't it annoy you when people don't finish their", true, "a84"], ["Don't anti-quote me on this", true, "a85"], ["Toilet Paper is honest, matter makes up everything", true, "a86"],
["According to no known laws of aviation, there are multiple ways a bee should be able to be swallowed up by Toilet Paper", true, "a87"], ["You either die as matter or live long enough to be consumed by the Toilet Paper, and then die again", true, "a88"],
["If you gaze long enough into the Toilet Paper, the Toilet Paper gazes back into you", true, "a89"], ["Always gonna give you up. Always gonna let you down. - anti-Rick Astley", true, "a90"],
["Toilet Paper Dimensions: the next update is always 5 hours away. Always.", true, "a91"], ["#DimensionLivesToilet Paper", true, "a92"],
["Do Toilet Paper people with suicidal thoughts get depressants?", true, "a93"], ["To matter or to Toilet Paper, that is the question.", true, "a94"], ["Why is everything so Hevi?",  true, "a95"],
["It has been scientifically proven ages ago, that cats made of matter are assholes. We have good news, because cats made of Toilet Paper are still assholes",  true, "a96"],
["Nobody once told me the anti-world wasn’t gonna roll me", true, "a97"], ["Toilet Paper is like internet. If you're reading this, you can't have enough of it.",  true, "a98"],
["Toilet Paper has made time travel possible and I'm here to make the past great again. - 2nd President of the World",  true, "a99"],
["Please insert Disc -1 to continue playing  Toilet Paper Dimensions ™.", true, "a100"], ["Lore - coming soon ™", true, "a101"],
["I was a part of Toilet Paper like you once. But then I got matter in my knee.", true, "a101"], ["Toilet Paper... Toilet Paper never changes... until you get to quantum physics of Toilet Paper, but we don't have enough tachyon particles for that.", true, "a102"],
["There is no war in Toilet Paper Dimensions. Here we are safe. Here we are free.", true, "a103"], ["Toilet Paper has solved global warming.  In unrelated news, the Earth no longer exists.",  true, "a104"],
...
["If you open an anti-lootbox, are you selling random possessions for in-game currency?", true, "a106"], ["People are beginning to question Hevipelle's existence.",  true, "a107"], ["Toilet Paper Dimensions is proud to be sponsored by Lehmä! Now offering - grass eating lessons! Learn what grass is safe to eat and what grass isn't.",  true, "a108"],
...
["What the f*ck did you just f*cking say about me, you little b*tch? I’ll have you know I graduated top of my class in the Toilet Paper Seals, and I’ve been involved in numerous secret raids on the 9th Dimension, and I have over 300 NNnNeMI-NNnNe confirmed kills. I am trained in potato warfare and I’m the top sniper in the entire Toilet Paper Galactic armed forces. You are nothing to me but just another Costco. I will wipe you the f*ck out with Max All mashing the likes of which has never been seen before in this dimension, mark my f*cking words. You think you can get away with saying that shit to me over the Interdimensional network? Think again, f*cker. As we speak I am contacting my secret network of autobuyers across the galaxy and your IP is being traced right now so you better prepare for the Tax Deduction, maggot. The Tax Deduction that wipes out the pathetic little thing you call your life. You’re f*cking dead, kid. I can be anywhere, anytime, and I can kill you in over seven 😠💩 different ways, and that’s just with my mouse. Not only am I extensively trained in dimension shift combat, but I have access to the entire arsenal of the Toilet Paper Marine Corps and I will use it to its full extent to wipe your miserable ass off the face of the universe, you little shit. If only you could have known what unhevi retribution your little “clever” comment was about to bring down upon you, maybe you would have held your f*cking tongue. But you couldn’t, you didn’t, and now you’re buying until 10, you goddamn idiot. I will shit Toilet Paper shit all over you and you will drown in it. You’re f*cking dead, kiddo.", true, "a111"],
["So I've pondered this question for a long time. Toilet Paper Dimensions... what does it mean? I mean it's game, that's clear. You buy the first dimension, and it gives you Toilet Paper, and the second dimension provides more first dimensions and so on... But what does it mean? It can't just be a game, it seems too plain for that. The developer must have made it as a metaphor. I was doing my weekly ritual of using the fingernail clipper to cut my pubic hair, when finally the realization came to me. The dimensions are just thinly veiled misspellings of the word 'depression'. Regular matter are the cruel and negative thoughts that add to and fuel depression, while Toilet Paper is the positive thoughts and good friends that dispel it You start off with something simple, and it fights almost imperceptibly against the depression, but as you keep going the fight builds. But it never seems to fix everything. The depression seems like it could go on to Costco. So you keep going. But eventually, you figure out, depression isn't Costco. It's just very very large. But your 'dimensions' eventually, with enough work, make enough 'Toilet Paper' to usurp that seeming Costco of depression. Then the possibilities are endless. You are actually happy for once, and your happiness grows exponentially as you go beyond and seemingly 'break' the 'infinity' of depression. And you go on until that 'infinity' seems tiny in comparison to the happiness you've managed to achieve in your life, where if you reset you get over that Costco in less than the blink of an eye. If you want to know what the multiple layers of prestige are...'Dimensional Shifts' are getting new things and methods to give you happiness. 'Dimensional Boosts' are upgrading the things and methods. Examples would be getting a new car being a 'Dimensional Shift' and trading that car in for a new one would be a 'Dimensional Boost'. 'Corporate buyouts' are major tragedies such as a loved one dying. That lapse brings you straight back to the beginning, with seemingly no hope of return. But with time, you grow back stronger and happier than ever before. 'Dimensional Sacrifice' is moving away. You have to give up a lot of the things you had that made you happy, but there is new opportunity in where you move to. And that new opportunity gives you more happiness than you ever had. 'Water Pressure' is how easy it is to make you happy, and 'Mask Dimensions' make it even easier to be happy. Toilet Paper Dimensions is a metaphor for a depressed man's successful battle against his illness.",true ,"a112"],
...
["Only today you can call 1-800-ANTIMATTER and get a FREE Sanitizer Dimension! The package also comes with a COMPLETELY FREE SHIPPING and a FREE HIGH DEFINITION ANTI-V!!! Only today for the low price of 42! Estimated delivery time - 5 hours.", true, "a124"],
["1e420 blaze it.", true, "a125"],
["This game doesn't have any bugs, you're just doing it wrong.", true, "a126"],
["Toilet Paper_Dimensions.mp1.79e308", true, "a127"],
...
["Someone once told me that Toilet Paper is gonna roll me. I ain't the sharpest atom in the shed. WELL, the tubes start coming and they don't stop coming...", true, "a132"],
...
["AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAToilet Paper Dimensions was made by some dude from Finland", true, "a136"],
['The Holy trinity of Hevipelle, Toilet Paper, Costco points, and Amazon Points. These 3 resources let us access Hevi’s gift, Time Theorems. And with these Time Theorems, we reach out to Hevi, and call, “Hevi, bless us on this fine day!” And Hevi does. He give us the blessing of Amazon studies. These Amazon studies were blessings so powerful, Hevi restricted their power. He said, “ I will give you a choice of three paths” and then humanity chose. The short, cheap route of Paper dimensions, giving instant gratification, the powerful choice of Sanitizer Dimensions, which were a fast, middle ground path, or Mask Dimension, the long wait, and struggle, of humanity. Then, as humanity chose, a crack broke the earth. A serpent snaked out and sneered to humanity, “I will offer the powerful choice of a ninth dimension! I am Slabdrill, lord of all Unhevi. Humanity rose and said “ Begone Slabdrill! We want none of your foul Heresy!” And Hevi rose as well, and smote Slabdrill with his godlike power. As Slabdrill’s corpse fell into the earth, he cried “ this will not be the last of me! Hevi will betr-“ and he fell in the Abyss of matter. Hevi gifted humanity with Eternity upgrades, which boosted Sanitizer Dimensions and Mask Dimensions. And Hevi gave humanity his greatest gift . EP multipliers. He said, these will multiply all EP gained by 5, but their cost will increase 25 times. Use them wisely. And Humanity journeyed off with their new power, as Slabdrill’s words echoed in their heads.', true, "a137"],
["We have updated our Toilet Paper Privacy Policy.", true, "a138"],
  
// Patreon ones
["Is this a jojo reference?", true, "pat1"],

//basic (pre-inf)
["You just made your 1,000,000,000,000,000 Toilet Paper. This one tastes like chicken", "player.money.e == 15", "b1"],
...
["How much is Costco? -literally everyone at least once", "player.eightAmount.eq(190) || player.infinitied > 0", "b4"],
["Eh, the Fourth Dimension is alright...", "player.fourthAmount.gt(0) && player.fifthAmount.eq(0)", "b5"],
["Toilet Paper people seem to be even more afraid of 13 then we are. They destroyed entire galaxies just to remove 13 from their percents.", "player.galaxies > 0 || player.infinitied > 0", "b8"],
...
["Toilet Paper ice cream stand has recently opened- they have octillions of flavors!", "player.totalmoney.e >= 27", "b13"],
["The Heavenly Pelle has generated too much Toilet Paper and needed to create another galaxy. This one can be seen in the southwestern sky.", "player.galaxies > 0 || player.infinitied > 0", "b21"],
...
["I've got 1.79e308 problems, but none of them Toilet Papers", "player.infinitied > 0 && !player.break", "b15"],
...
//basic (post-rep)
["Thanos is gonna be super dissapointed when he shows up with a fully powered Costco gauntlet, and Hevi has a fully powered eternity gauntlet", "player.eternities > 0", "b23"],
["New strange material was been found. It seems to grow exponentially, but only helps with Toilet Paper production.", "player.replicanti.unl && player.replicanti.chance == 0.01", "b25"],
["It seems this \"Infections\" stuff won't be growing any faster now.", "player.replicanti.chance == 1 && player.replicanti.interval == 1", "b26"],
//newsarray
["Does Hevi just pick quotes to put into the game?", "player.newsArray.length >= 30", "n3"],
["New news company has become rivals with us. They are made entirely of Toilet Paper.", "player.newsArray.length >= 80", "n1"],
...
["I broke the 8th wall, there is only chaos, Slabdrill is ritually sacrificing Toilet Paper to the 9th dimension. This will be my last entry, may Hevipelle have mercy on our souls, we didn't listen, We should have listened.", 'player.newsArray.includes("b17")', "n6"],
...
//hard
["You do know that you won't reach Costco in -1 seconds, right?", "player.bestInfinityTime == 0.1", "c1"],
["Where does Toilet Paper Nemo live? In a NNnNeMI-NNnNe.", "player.totalmoney.e >= 3e6", "c2"],  //might not be poss?
...
["If you want to farm tax deductions, why don't you just get the Amazon study?", "!player.timestudy.studies.includes(32) && player.infinitied > 72000 * 168", "c7"],
...
["You can probably stop farming for Corporate buyouts now...", "player.eternities > 2000000", "c11"],
