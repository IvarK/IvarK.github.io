...
function updateNewsArray() {
    newsArray = [//always true
        ...
        ["Most quotes found online are falsely attributed -Abraham Lincoln", true, "a72"],
...
//basic (post-rep)
        ["Thanos is gonna be super disappointed when he shows up with a fully powered infinity gauntlet, and Hevi has a fully powered eternity gauntlet", "player.eternities > 0", "b23"],
...
//newsarray
        ...
        ["Asian man trys to steal the trophy of fastest infinity of -1 seconds, AND HE DOES IT!", 'player.newsArray.includes("c1")', "n4"],
